...
require (
	github.com/ymtdzzz/opentelemetry-collector-extra/receiver/newrelicreceiver v0.0.0
...
replace github.com/ymtdzzz/opentelemetry-collector-extra/receiver/newrelicreceiver => ../receiver/newrelicreceiver
